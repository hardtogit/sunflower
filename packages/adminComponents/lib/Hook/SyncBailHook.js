...
function (_HookCodeFactory) {
  ...
  function SyncBailHookCodeFactory() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SyncBailHookCodeFactory).call(this));
  }
...
function (_Hook) {
  ...
  function SyncBailHook(args) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SyncBailHook).call(this, args));
  }
